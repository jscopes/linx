<?php
/**
 * Template name: Hero Image (Full Width)
 *
...
<div class="wrapper" id="page-wrapper">
	<div class="<?php echo esc_attr( $container ); ?>" id="content" tabindex="-1">
        <main class="site-main template-hero" id="main" data-template-name="template-hero">
            ...
            <?php if( get_field('hero_image') ): ?>
                ...
                <div id="hero" class="w-100 hero-sm dark" style="background-image: url('<?php echo $heroImage['url']; ?>');">
                    <div class="container">
                        <div class="row">
                            <div class="hero-inner col-sm-8 col-md-7X col-lg-5X">
